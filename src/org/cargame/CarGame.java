  ...
  public void render(GameContainer container, Graphics g) throws SlickException {
    ...
    for (HoverCraft car : mCars.values()) {
      ...
      if (jammer > 500)
        ...
        if (car != mPlayerCraft)
          g.drawString(car.getName(), draw_offset_x + car.getX()
              - mPlayerCraft.getX() - g.getFont().getWidth(car.getName()) / 2,
    ...
    // Scoreboard
    g.setColor(Color.green);
    g.drawString("You: " + mPlayerCraft.getLives(), container.getWidth() - 100,
        15);
